      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10">
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-extrabold text-background font-nunito">EduVoice CMS</span>
          </div>
        ...
        <div>
          <h4 className="text-lg font-bold text-background mb-4 font-nunito">Producto</h4>
        ...
        <div>
          <h4 className="text-lg font-bold text-background mb-4 font-nunito">Recursos</h4>
          <ul className="space-y-3 text-sm font-lato">
        ...
        <div>
          <h4 className="text-lg font-bold text-background mb-4 font-nunito">Empresa</h4>
          <ul className="space-y-3 text-sm font-lato">
